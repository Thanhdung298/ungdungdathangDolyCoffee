          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                kSizedBox,
                Text(
                  "Giá: ${NumberFormat.currency(decimalDigits: 0, symbol: '')
                      .format(drink.price)} vnđ",
                ),
                kSizedBox,
                Text(
                  "Tổng • ${NumberFormat.currency(decimalDigits: 0, symbol: '')
                      .format(drink.price * drink.qty)} vnđ",
                ),
